...
namespace MvcApp.Core.Extensions
{
    public static class EnumerableExtensions
    {
        ...
        public static SelectListItem Set(this SelectListItem item, string text, string value)
        {
            item.Text = text;
            item.Value = value;
            return item;
        ...
        public static List<T> DistinctByKey<T, TKey>(this IEnumerable<T> source, Func<T, TKey> key)
        {
            if (source == null)
            {
                return null;
